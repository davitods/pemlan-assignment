...
public class swalayan {
    ...
    public void autentifikasi(String nomorPelanggan1, String Pin1){
        if(valid==3){
            System.out.println("Anda telah melebihi batas autentifikasi. Akun Anda telah diblokir");
            ...
            if(nomorPelanggan1.equals(nomorPelanggan)){
                ...
                System.out.println("Kesalahan Autentifikasi. PIN yang Anda masukkan salah"); 
                }
            } else {
            System.out.println("Maaf, akun yang Anda masukkan tidak terdeteksi");   
            }
            valid++;
        }
    }
